...
public:
    ...
    void retranslateUi(QWidget *consoleWidget)
    {
        ...
        spinBox_lines->setSuffix(QApplication::translate("consoleWidget", " lines", nullptr));
        spinBox_time->setSuffix(QApplication::translate("consoleWidget", " ms", nullptr));
        pushButton_clear->setText(QApplication::translate("consoleWidget", "Clear", nullptr));
    } // retranslateUi
