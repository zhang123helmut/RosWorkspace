...
public:
    ...
    void retranslateUi(QDialog *EditConstraintDialog)
    {
        ...
        linear_sigma->setSuffix(QApplication::translate("EditConstraintDialog", " m", nullptr));
        angular_sigma->setSuffix(QApplication::translate("EditConstraintDialog", " rad", nullptr));
        label_7->setText(QApplication::translate("EditConstraintDialog", "<html><head/><body><p>Linear &sigma; </p></body></html>", nullptr));
        label_8->setText(QApplication::translate("EditConstraintDialog", "<html><head/><body><p>Angular \317\203</p></body></html>", nullptr));
        checkBox_radians->setText(QApplication::translate("EditConstraintDialog", "Radians", nullptr));
        label_9->setText(QApplication::translate("EditConstraintDialog", "<html><head/><body><p>Setting &sigma; to 0 will set identity covariance.</p></body></html>", nullptr));
    } // retranslateUi
