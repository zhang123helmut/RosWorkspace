...
public:
    ...
    {
        ExportBundlerDialog->setWindowTitle(QApplication::translate("ExportBundlerDialog", "Export Bundler", nullptr));
        groupBox->setTitle(QApplication::translate("ExportBundlerDialog", "Motion Blur Filtering", nullptr));
        label_40->setText(QApplication::translate("ExportBundlerDialog", "These optional parameters can be used to avoid exporting blurred images. 0 means not used.", nullptr));
        doubleSpinBox_laplacianVariance->setSuffix(QString());
        label_38->setText(QApplication::translate("ExportBundlerDialog", "Laplacian variance threshold. Below this threshold, the image is considered blurred. 50 can be good default.", nullptr));
        doubleSpinBox_linearSpeed->setSuffix(QApplication::translate("ExportBundlerDialog", " m/s", nullptr));
        label_39->setText(QApplication::translate("ExportBundlerDialog", "Maximum linear speed. Images taken on fast motions would be more blurry. 0.1 m/s can be good default.", nullptr));
        doubleSpinBox_angularSpeed->setSuffix(QApplication::translate("ExportBundlerDialog", " rad/s", nullptr));
        label_41->setText(QApplication::translate("ExportBundlerDialog", "Maximum angular speed. Images taken on fast motions would be more blurry. 0.4 rad/s can be good default.", nullptr));
        groupBox_export_points->setTitle(QApplication::translate("ExportBundlerDialog", "Export 3D Points", nullptr));
        label_8->setText(QApplication::translate("ExportBundlerDialog", "SBA Iterations", nullptr));
        label_variance->setText(QApplication::translate("ExportBundlerDialog", "SBA Pixel variance used by g2o.", nullptr));
        sba_variance->setSuffix(QString());
        label_10->setText(QApplication::translate("ExportBundlerDialog", "SBA Type", nullptr));
        comboBox_sbaType->setItemText(0, QApplication::translate("ExportBundlerDialog", "g2o", nullptr));
        comboBox_sbaType->setItemText(1, QApplication::translate("ExportBundlerDialog", "cvsba", nullptr));

        label_variance_2->setText(QApplication::translate("ExportBundlerDialog", "Rematch features.", nullptr));
        sba_rematchFeatures->setText(QString());
        label_42->setText(QApplication::translate("ExportBundlerDialog", "Output folder:", nullptr));
        toolButton_path->setText(QApplication::translate("ExportBundlerDialog", "...", nullptr));
    } // retranslateUi
