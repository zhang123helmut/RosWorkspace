...
public:
    ...
    {
        loopClosureViewer->setWindowTitle(QApplication::translate("loopClosureViewer", "Form", nullptr));
        label_idA->setText(QString());
        label_idB->setText(QString());
        label_transform->setText(QString());
        checkBox_rawCloud->setText(QApplication::translate("loopClosureViewer", "Raw  cloud", nullptr));
    } // retranslateUi
