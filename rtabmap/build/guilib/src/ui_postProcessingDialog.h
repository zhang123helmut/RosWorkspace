...
public:
    ...
    {
        PostProcessingDialog->setWindowTitle(QApplication::translate("PostProcessingDialog", "Post-Processing", nullptr));
        detectMoreLoopClosures->setTitle(QApplication::translate("PostProcessingDialog", "Detect more loop closures", nullptr));
        clusterAngle->setSuffix(QApplication::translate("PostProcessingDialog", " degrees", nullptr));
        clusterRadius->setSuffix(QApplication::translate("PostProcessingDialog", " m", nullptr));
        label_3->setText(QApplication::translate("PostProcessingDialog", "Cluster radius", nullptr));
        clusterAngle_label->setText(QApplication::translate("PostProcessingDialog", "Cluster angle", nullptr));
        label_6->setText(QApplication::translate("PostProcessingDialog", "Iterations", nullptr));
        label_7->setText(QApplication::translate("PostProcessingDialog", "Intra-session", nullptr));
        label_9->setText(QApplication::translate("PostProcessingDialog", "Inter-session", nullptr));
        intraSession->setText(QString());
        interSession->setText(QString());
        label->setText(QApplication::translate("PostProcessingDialog", "See \"RTAB-Map settings/Motion Estimation\" to tune the parameters used.", nullptr));
        groupBox_3->setTitle(QApplication::translate("PostProcessingDialog", "Refine links with ICP", nullptr));
        label_2->setText(QApplication::translate("PostProcessingDialog", "Laser scans are required. See \"RTAB-Map settings/Motion Estimation/ICP\" to tune the parameters used.", nullptr));
        refineNeighborLinks->setText(QApplication::translate("PostProcessingDialog", "Refine neighbor links", nullptr));
        refineLoopClosureLinks->setText(QApplication::translate("PostProcessingDialog", "Refine loop closure links", nullptr));
        sba->setTitle(QApplication::translate("PostProcessingDialog", "Sparse Bundle Adjustment (SBA)", nullptr));
        label_8->setText(QApplication::translate("PostProcessingDialog", "Iterations", nullptr));
        label_variance->setText(QApplication::translate("PostProcessingDialog", "Pixel variance used by g2o.", nullptr));
        sba_variance->setSuffix(QString());
        label_10->setText(QApplication::translate("PostProcessingDialog", "Type", nullptr));
        comboBox_sbaType->setItemText(0, QApplication::translate("PostProcessingDialog", "g2o", nullptr));
        comboBox_sbaType->setItemText(1, QApplication::translate("PostProcessingDialog", "cvsba", nullptr));
        comboBox_sbaType->setItemText(2, QApplication::translate("PostProcessingDialog", "Ceres", nullptr));

        label_variance_2->setText(QApplication::translate("PostProcessingDialog", "Rematch features.", nullptr));
