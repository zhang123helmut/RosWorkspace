...
public:
    ...
    {
        DepthCalibrationDialog->setWindowTitle(QApplication::translate("DepthCalibrationDialog", "Depth Calibration", nullptr));
        ...
        groupBox_2->setTitle(QApplication::translate("DepthCalibrationDialog", "Map generation", nullptr));
        checkBox_laserScan->setText(QString());
        label_110->setText(QApplication::translate("DepthCalibrationDialog", "Use 3D laser scans for 3D map.", nullptr));
        label_108->setText(QApplication::translate("DepthCalibrationDialog", "Decimation (1-2-4-8-...).", nullptr));
        doubleSpinBox_maxDepth->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", nullptr));
        label_132->setText(QApplication::translate("DepthCalibrationDialog", "Maximum depth (0 means no limit).", nullptr));
        doubleSpinBox_minDepth->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", nullptr));
        label_133->setText(QApplication::translate("DepthCalibrationDialog", "Minimum depth.", nullptr));
        doubleSpinBox_voxelSize->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", nullptr));
        label_voxel->setText(QApplication::translate("DepthCalibrationDialog", "Voxel size. Set 0 to disable.", nullptr));
        groupBox->setTitle(QApplication::translate("DepthCalibrationDialog", "Distortion Model", nullptr));
        spinBox_bin_width->setSuffix(QApplication::translate("DepthCalibrationDialog", " pix", nullptr));
        label_113->setText(QApplication::translate("DepthCalibrationDialog", "Bin width. Should be a multiple of image width.", nullptr));
        label_117->setText(QApplication::translate("DepthCalibrationDialog", "Bin depth.", nullptr));
        label_120->setText(QApplication::translate("DepthCalibrationDialog", "Image height.", nullptr));
        label_116->setText(QApplication::translate("DepthCalibrationDialog", "Bin height. Should be a multiple of image height.", nullptr));
        spinBox_bin_height->setSuffix(QApplication::translate("DepthCalibrationDialog", " pix", nullptr));
        label_118->setText(QApplication::translate("DepthCalibrationDialog", "Maximum depth.", nullptr));
        label_115->setText(QApplication::translate("DepthCalibrationDialog", "Smoothing.", nullptr));
        label_119->setText(QApplication::translate("DepthCalibrationDialog", "Image width.", nullptr));
        label_width->setText(QApplication::translate("DepthCalibrationDialog", "NA", nullptr));
        label_height->setText(QApplication::translate("DepthCalibrationDialog", "NA", nullptr));
        doubleSpinBox_bin_depth->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", nullptr));
        doubleSpinBox_maxDepthModel->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", nullptr));
        doubleSpinBox_coneRadius->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", nullptr));
        doubleSpinBox_coneStdDevThresh->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", nullptr));
        label_voxel_2->setText(QApplication::translate("DepthCalibrationDialog", "Cone radius.", nullptr));
        label_voxel_3->setText(QApplication::translate("DepthCalibrationDialog", "Cone standard deviation threshold.", nullptr));
        label_109->setText(QApplication::translate("DepthCalibrationDialog", "Reset previous model.", nullptr));
        checkBox_resetModel->setText(QString());
        label_112->setText(QApplication::translate("DepthCalibrationDialog", "Current model:", nullptr));
        label_trainingSamples->setText(QApplication::translate("DepthCalibrationDialog", "0", nullptr));
        label_114->setText(QApplication::translate("DepthCalibrationDialog", "training samples", nullptr));
    } // retranslateUi
